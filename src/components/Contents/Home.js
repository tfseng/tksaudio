        ...
        <div className = {props.page.home.page}>
            <div className = "home-container">
                <div>
                    ...
                    <p className = "home-text">I’m a junior year undergraduate student at Berklee College of Music, and an aspiring audio producer, sound designer and composer. Welcome to my Sound Design portfolio website.</p>
